  ...
  <div class="app-container">
    <el-form :inline="true" class="demo-form-inline">
      <el-form-item label="班级名称">
        <el-input v-model="dataVo.className" placeholder="请输入班级名称" />
      </el-form-item>
    ...
    >
      ...
      <el-table-column prop="classDetail" label="班级介绍" />
    ...
    >
      ...
      <el-form :model="formData" label-position="left" label-width="100px">
        <el-form-item label="班级名称">
          <el-input v-model="formData.className" placeholder="请填写班级名称"/>
        </el-form-item>
        <el-form-item label="班级介绍">
          <el-input v-model="formData.classDetail"  type="textarea"
                    :rows="2" placeholder="请填写班级介绍"/>
        </el-form-item>
      </el-form>
...
<script>
import {pageQuery, update, insert, deleteById} from '@/api/class'
export default {
  data() { // 定义变量和初始值
    return {
      list: [], // 查询之后接口返回集合
